Feature: Overview page
  ...
  Scenario: visiting overview page
       ...
       Then I should get back a status of 200
        ...
        And the 2nd section description should be "Percentage of unique visitors who arrived at each stage of the licensing submission journey \(based on sampled data\)"
