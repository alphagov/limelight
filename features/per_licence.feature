  ...
  Scenario: licence exists
      Given API responds with application-to-licence-a-street-collection.json
       ...
       Then I should get back a status of 200
        ...
        And the 1st section description should be "Total licence applications over the last 9 weeks and top authorities by licence application volume in this time"
