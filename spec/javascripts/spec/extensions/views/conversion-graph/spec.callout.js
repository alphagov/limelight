  ...
  describe("ConversionCallout", function () {
    ...
    describe("rendering", function () {
      ...
      it("creates a callout with information about the currently selected item", function () {
        ...
        expect(view.$el.find('dl')).toHaveHtml('<dt>Unique visitors to stage:</dt><dd>12 (34%)</dd>');
        ...
        expect(view.$el.find('dl')).toHaveHtml('<dt>Unique visitors to stage:</dt><dd>15 (42%)</dd>');
        ...
        expect(view.$el.find('dl')).toHaveHtml('<dt>Unique visitors to stage:</dt><dd>18 (51%)</dd>');
        ...
        expect(view.$el.find('dl')).toHaveHtml('<dt>Unique visitors to stage:</dt><dd>21 (29%)</dd>');
        ...
        expect(view.$el.find('dl')).toHaveHtml('<dt>Unique visitors to stage:</dt><dd>24 (33%)</dd>');
        ...
        expect(view.$el.find('dl')).toHaveHtml('<dt>Unique visitors to stage:</dt><dd>27 (37%)</dd>');
      });
