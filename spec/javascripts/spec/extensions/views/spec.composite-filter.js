define([
  'extensions/views/composite-filter',
  'extensions/collections/filteredcollection'
],
function (CompositeFilter, Collection) {
  ...
  describe("initialize", function () {
    ...
    it("listens to reset events of the filtered collections", function () {
      console.log("before");
      ...
      expect(collection1.filtered.on).toHaveBeenCalledWith('reset', view.hideShowElements, view);
      expect(collection2.filtered.on).toHaveBeenCalledWith('reset', view.hideShowElements, view);
    });
  });
