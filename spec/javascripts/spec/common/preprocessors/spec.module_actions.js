  ...
  describe('Module actions', function() {
    ...
    describe('touch behaviour', function() {
      ...
      beforeEach(function() {
        ...
        $('body').append($('<aside class="more-info" id="module1"><span class="more-info-link"></span><ul><li>'));
      ...
      it("should close other open callouts on touch", function () {
        $('body').append($('<aside class="more-info" id="module2"><span class="more-info-link"></span><ul><li>'));
        applyModuleActions();
