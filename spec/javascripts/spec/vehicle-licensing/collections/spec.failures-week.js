...
function (Collection, Query) {
  describe("Vehicle Excise Duty Failures Collection", function () {
    ...
    describe("queryParams", function () {
      ...
      it("queries for failures in a previous week grouped by reason", function () {
